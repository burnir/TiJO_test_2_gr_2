...
var fragments = function (text)
{
    ...
    var mapping = {
        goodNewsText: element.bind(null, by.id('burnir')),
        abcLabel: element.bind(null, by.id('rafal')),
        cdeLabel: element.bind(null, by.id('burnat')),
        input: element.bind(null, by.id('pozdrowienia'))
    };
